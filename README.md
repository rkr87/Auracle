...
An aura status improvement mod for **Divinity: Original Sin 2** - requires [Norbyte's Divinity Script Extender](https://github.com/Norbyte/ositools/releases).
...
- Leadership (from 8)
- Guardian Angel Aura (from 5)
- Favourable Wind Aura (from 10)
- Evasion Aura (from 8)
- Fire Brand (from 8)
- Venom Aura (from 8)
- Vampiric Hunger Aura (from 13)
